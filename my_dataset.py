...
class DUTSDataset(data.Dataset):
    def __init__(self, root: str, train: bool = True, transforms=None):
        ...
        if train:
            self.image_root = os.path.join(root, "DUTS-TR-ALL", "DUTS-TR-Image")
            self.mask_root = os.path.join(root, "DUTS-TR-ALL", "DUTS-TR-Mask")
        #如果是服务器，改成绝对路径
            #self.image_root = "/data/coding/u2net/DUTS-TR-ALL/DUTS-TR-Image"
            #self.mask_root = "/data/coding/u2net/DUTS-TR-ALL/DUTS-TR-Mask"
        else:
            self.image_root = os.path.join(root, "DUTS-TE2", "DUTS-TE-Image")
            self.mask_root = os.path.join(root, "DUTS-TE2", "DUTS-TE-Mask")
            # 如果是服务器，改成绝对路径
            # self.image_root = "/data/coding/u2net/DUTS-TE2/DUTS-TE-Image"
            # self.mask_root = "/data/coding/u2net/DUTS-TE2/DUTS-TE-Mask"
